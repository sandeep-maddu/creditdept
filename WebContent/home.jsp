...
<title>Home page of creditdept</title>
</head>

<body>
<link href="style.css" rel="stylesheet" type="text/css">

<h1 style="color:#6495ed" align="center">
CREDITDEPT SOFTWARE
</h1><br>
...
List<Account> accountlist=dao.get_all_accounts();
%>

<form action="account_summary.jsp" method="post">
<br>
<h3>Select account</h3> <select name="aid">
